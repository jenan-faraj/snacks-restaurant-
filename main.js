...
// let nameInput = document.querySelector('[placeholder="Name"]').value;
// let genderInput = document.querySelector('[placeholder="Gender"]').value;
// let ageInput = document.querySelector('[placeholder="Age"]').value;

// let shawerma = document.querySelector('[for="shawerma"]').value;
// let zinger = document.querySelector('[for="zinger"]').value;
// let borger = document.querySelector('[for="borger"]').value;

// let Sandwich = document.querySelector('[for="Sandwich"]').value;
// let Combo = document.querySelector('[for="Combo"]').value;
...
//   // جلب القيم الجديدة عند الضغط على Submit
//   let nameInput = document.querySelector('[placeholder="Name"]').value;
//   let genderInput = document.querySelector('[placeholder="Gender"]').value;
//   let ageInput = document.querySelector('[placeholder="Age"]').value;

//   // جلب الخيار المحدد من radios
...
//   // جلب الخيار المحدد من مجموعة أخرى
//   let sandwichOrCombo = document.querySelector('[name="meal-type"]:checked')?.value || "No Meal Type";

//   // تحديث المخرجات
//   output.textContent =
//     `Name: ${nameInput}, Gender: ${genderInput}, Age: ${ageInput}, ` +
//     `Meal: ${shawerma || zinger || borger}, Option: ${sandwichOrCombo}`;
// });
...
form.addEventListener("submit", (e) => {
  ...
  output.textContent = `Name: ${nameInput}, Gender: ${genderInput}, Age: ${ageInput}, Meal: ${
    shawerma || zinger || borger
